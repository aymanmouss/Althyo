...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cal.eu https://*.cal.eu https://*.cal.com https://analytics.althyo.fr",
      ...
      "connect-src 'self' https://cal.eu https://*.cal.eu https://*.cal.com https://analytics.althyo.fr",
